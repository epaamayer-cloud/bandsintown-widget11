...
widgetContainer.innerHTML = `
  <a class="bit-widget-initializer" data-artist-name="DeinArtistName" href="https://www.bandsintown.com/a/DeinArtistName?utm_source=website&utm_medium=web&utm_campaign=widget">Tourdates</a>
  <script>(function(d,s,id){
    var js,fjs=d.getElementsByTagName(s)[0];
    if(!d.getElementById(id)){
      js=d.createElement(s);
      js.id=id;
      js.src='https://widget.bandsintown.com/main.min.js';
      fjs.parentNode.insertBefore(js,fjs);
    }
  }(document,'script','bit-widget'));</script>
`;
